...
public class AudioFolderFragment extends Fragment implements FolderItemClickListener, TabActivityListener {
...
//    private RequestParameters mRequestParameters;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        UtilityMethods.reportGoogleAnalytics(AudioFolderFragment.class.getName(), "onCreate");
    }
...
//        myMoPubAdapter.loadAds(getString(R.string.mopub_ads_placement_id),mRequestParameters);
        ...
        private void showAllItemsFolders() {
            ...
            new FindAllFoldersAsyncTask(context, callback, AppConstants.ITEM_TYPE_AUDIO).execute();
        }
