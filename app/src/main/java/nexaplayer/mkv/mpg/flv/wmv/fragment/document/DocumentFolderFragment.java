...
public class DocumentFolderFragment extends Fragment implements FolderItemClickListener, TabActivityListener {
...
//    private RequestParameters mRequestParameters;
    ...
    public DocumentFolderFragment() {
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        UtilityMethods.reportGoogleAnalytics(DocumentFolderFragment.class.getName(), "onCreate");
    }
...
//        myMoPubAdapter.destroy();
    ...
    private void setupFolderRecyclerView(){
        folderLayoutManager = new LinearLayoutManager(getActivity());
...
//        myMoPubAdapter.loadAds(getString(R.string.mopub_ads_placement_id),mRequestParameters);
        ...
        private void showAllItemsFolders() {
            ...
            new FindAllFoldersAsyncTask(context, callback, AppConstants.ITEM_TYPE_DOCUMENT).execute();
        }
